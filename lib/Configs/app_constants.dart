...
final chatBlack = new Color(0xFF1E1E1E);
final chatBlue = new Color(0xFF02ac88);
final chatDeepGreen = new Color(0xFF01826b);
final chatLightGreen = new Color(0xFF02ac88);
final chatgreen = new Color(0xFF098b74);
final chatteagreen = new Color(0xFFe9fedf);
final chatWhite = Colors.white;
final chatGrey = Color(0xff85959f);
final chatChatbackground = new Color(0xffe8ded5);
...
final statusBarColor = chatDeepGreen;
...
// final chatBlack = new Color(0xFF353f58);
// final chatBlue = new Color(0xFF3d9df5);
// final chatDeepGreen = new Color(0xFF296ac6);
// final chatLightGreen = new Color(0xFF036eff);
// final chatgreen = new Color(0xFF06a2ff);
// final chatteagreen = Color(0xFFeefcf8);
// final chatWhite = Colors.white;
// final chatGrey = Colors.grey;
// final chatChatbackground = new Color(0xffdde6ea);
...
// final statusBarColor = chatWhite;
// final isDarkIconsinStatusBar =
...
//Also don't forget to Change the Admob App Id in "chat/android/app/src/main/AndroidManifest.xml" & "chat/ios/Runner/Info.plist"
...
//*--App Configurations---
const Appname =
    'chat'; //app name shown evrywhere with the app where required
