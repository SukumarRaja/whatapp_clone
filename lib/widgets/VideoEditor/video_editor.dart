...
import 'package:chat/Services/helpers/size.dart';
import 'package:chat/Services/helpers/transition.dart';
import 'package:chat/Services/helpers/widgets/animated_interactive_viewer.dart';
import 'package:chat/Services/helpers/widgets/widgets.dart';
...
class _VideoEditorState extends State<VideoEditor> {
  ...
  Future<bool> onWillPop() {
    ...
    if (now.difference(currentBackPressTime!) > Duration(seconds: 3)) {
      ...
      chat.toast('Double Tap To Close Editor');
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Icon(
                  Icons.done,
                  color:
                      _isExporting.value ? Colors.transparent : chatgreen,
                ),
              ),
            ),
          ],
