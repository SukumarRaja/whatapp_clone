...
// import 'package:chat/widgets/Common/cached_image.dart';
...
//     var audio = "sounds/callingtone.mp3";
//     player =  audioCache.load(audio) as AudioPlayer;
//
//     setState(() {});
//   }
//
...
//     await _engine.joinChannel(token: Agora_TOKEN, channelId: widget.channelName!, uid: 0, options: ChannelMediaOptions());
//   }
//
...
//                     size: w > h ? 60 : 140,
//                     color: DESIGN_TYPE == Themetype.whatsapp
//                         ? chatWhite.withOpacity(0.25)
//                         : chatBlack.withOpacity(0.25),
//                   ),
//                 ),
//           SizedBox(height: 45),
//           Text(
...
//               fontWeight: FontWeight.bold,
//               color: DESIGN_TYPE == Themetype.whatsapp
//                   ? chatWhite.withOpacity(0.54)
//                   : chatBlack.withOpacity(0.54),
//               fontSize: 19,
//             ),
//           ),
//           SizedBox(
