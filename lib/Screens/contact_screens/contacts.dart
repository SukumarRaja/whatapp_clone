...
import 'package:chat/Screens/chat_screen/pre_chat.dart';
import 'package:chat/Screens/contact_screens/AddunsavedContact.dart';
...
class _ContactsState extends State<Contacts>
  ...
  Future<Map<String?, String?>> getContacts({bool refresh = false}) async {
    ...
    chat.checkAndRequestPermission(Permission.contacts).then((res) {
      if (res) {
        ...
        chat.showRationale(getTranslated(context, 'perm_contact'));
        Navigator.pushReplacement(context,
            new MaterialPageRoute(builder: (context) => OpenSettings()));
      }
    }).catchError((onError) {
      chat.showRationale('Error occured: $onError');
    });
  ...
  Icon _searchIcon = new Icon(
    Icons.search,
    color: DESIGN_TYPE == Themetype.whatsapp ? chatWhite : chatBlack,
  );
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chat.getNTPWrappedWidget(ScopedModel<DataModel>(
            model: widget.model!,
