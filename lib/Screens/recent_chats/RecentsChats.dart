...
import 'package:chat/Screens/recent_chats/widgets/getBroadcastMessageTile.dart';
import 'package:chat/Screens/recent_chats/widgets/getGroupMessageTile.dart';
import 'package:chat/Screens/recent_chats/widgets/getPersonalMessageTile.dart';
...
import 'package:chat/Utils/late_load.dart';
...
class RecentChatsState extends State<RecentChats> {
  ...
  buildPersonalMessage(
    ...
    String chatId =
        chat.getChatId(currentUserNo, realTimePeerData[Dbkeys.phone]);
    return streamLoad(
