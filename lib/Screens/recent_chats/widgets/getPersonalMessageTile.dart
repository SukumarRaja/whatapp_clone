...
import 'package:chat/Screens/recent_chats/widgets/getLastMessageTime.dart';
import 'package:chat/Screens/recent_chats/widgets/getMediaMessage.dart';
    ...
    tiles.add(ListTile(
        ...
        onTap: () async {
          ...
          FirebaseFirestore.instance
              ...
              .doc(chat.getChatId(currentUserNo, peer[Dbkeys.phone]))
              .update({
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (targetUser[Dbkeys.phone] != null) {
                          chat.toast(getTranslated(context, 'plswait'));
                ...
                if (cachedModel.currentUser![Dbkeys.locked] != null &&
                  ...
                  if (prefs.getString(Dbkeys.isPINsetDone) != currentUserNo ||
                    ...
                    ChatController.authenticate(
                        ...
                        shouldPop: false,
                        type:
                            chat.getAuthenticationType(false, cachedModel),
