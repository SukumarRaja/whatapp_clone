...
import 'package:chat/Screens/Broadcast/BroadcastChatPage.dart';
import 'package:chat/Screens/Groups/AddContactsToGroup.dart';
import 'package:chat/Screens/Groups/GroupChatPage.dart';
import 'package:chat/Screens/contact_screens/SmartContactsPage.dart';
...
import 'package:chat/Screens/chat_screen/utils/messagedata.dart';
...
import 'package:chat/Utils/alias.dart';
...
class RecentChatsWithoutLastMessageState
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      child: Text(
                        ...
                        style: TextStyle(color: chatgreen, fontSize: 18),
                      ),
                      onPressed: () {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (currentUserNo != null &&
                          ...
                          chat.toast('Error Occured. Could not delete !');
                        }
                      },
                    )
                  ],
    ...
    if (user[Dbkeys.phone] == currentUserNo) {
      ...
      return StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<MessageData> unreadData) {
          ...
          return Theme(
              data: ThemeData(
                  splashColor: chatGrey.withOpacity(0.2),
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = chat.getChatId(currentUserNo, user[Dbkeys.phone]);
        ...
        return Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                ...
                backgroundColor: chatLightGreen,
                child: Icon(
                  Icons.chat,
                  size: 30.0,
                ),
