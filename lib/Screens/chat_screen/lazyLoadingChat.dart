...
import 'package:chat/widgets/InfiniteList/InfiniteCOLLECTIONListViewWidget.dart';
import 'package:chat/widgets/MultiDocumentPicker/multiDocumentPicker.dart';
import 'package:chat/widgets/MultiImagePicker/multiImagePicker.dart';
...
import 'package:chat/widgets/VideoPicker/VideoPicker.dart';
...
class _LazyLoadingChatState extends State<LazyLoadingChat>
  ...
  void initState() {
    ...
    chatId = chat.getChatId(widget.currentUserNo, widget.peerNo);
...
//       //----sharing intent action:
  ...
  dynamic encryptWithCRC(String input) {
    try {
      ...
      chat.toast('Error occured while encrypting !');
      return false;
    }
  }
            ...
            if (content.trim() != '') {
              ...
              if (targetPeer == null) {
                await ChatController.request(
                    ...
                    chat.getChatId(widget.currentUserNo,
                        list[tempSendIndex][Dbkeys.phone]));
              }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chat.getNTPWrappedWidget(Consumer<List<GroupModel>>(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: chat.avatar(peer, radius: 20),
                                  ),
                                  SizedBox(
                                    width: 7,
                                  ),
