            ...
            children: [
                            ...
                            ListTile(
                              ...
                              leading: Padding(
                                ...
                                child: Icon(
                                  ...
                                  color: chatgreen.withOpacity(0.75),
                                  size: 26,
                                ),
                              ),
                              title: Text(
                              ...
                              subtitle: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 14,
                                      color: chatBlack.withOpacity(0.56)),
                                ),
                              ),
                            ),
                          ],
                          ...
                          ListTile(
                            trailing: SizedBox(
                                ...
                                child: Align(
                                  ...
                                  child: LinearProgressIndicator(
                                    backgroundColor:
                                        chatLightGreen.withOpacity(0.4),
              ...
              ListTile(
                ...
                title: Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: 16, color: chatBlack),
                ),
                subtitle: Padding(
                  padding: const EdgeInsets.only(top: 4),
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontSize: 14, color: chatBlack.withOpacity(0.56)),
                  ),
                ),
              ),
              ListTile(
            ...
            children: <Widget>[
              ...
              Padding(
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 14, color: chatBlack),
                    textAlign: TextAlign.center,
                  ),
