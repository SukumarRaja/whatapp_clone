...
import 'package:chat/Screens/homepage/homepage.dart';
...
import 'package:chat/widgets/PhoneField/intl_phone_field.dart';
import 'package:chat/widgets/PhoneField/phone_number.dart';
...
class LoginScreenState extends State<LoginScreen>
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      chat.toast('Authentication failed - ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      chat.toast('Authentication failed Timeout. please try again.');
    };
    ...
    // } catch (e) {
    //   chat.toast('NEW CATCH' + e.toString());
    // }
  }
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    try {
      ...
      if (firebaseUser != null) {
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            chat.toast("Failed to Login ! Please try again. ");
          }
        } else {
          ...
          if (fcmToken != null) {
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => chatWrapper())));
            chat.toast(getTranslated(this.context, 'welcomeback'));
          } else {
            unawaited(Navigator.pushReplacement(
                this.context,
                new MaterialPageRoute(
        ...
        chat.toast(getTranslated(this.context, 'failedlogin'));
      }
    } catch (e) {
      setState(() {
      ...
      if (e.toString().contains('invalid') ||
        ...
        chat.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
  ...
  void _changeLanguage(Language language) async {
    ...
    chatWrapper.setLocale(this.context, _locale);
    setState(() {
                  ...
                  decoration: BoxDecoration(
                    boxShadow: [
                      BoxShadow(
                        blurRadius: 3.0,
                        color: DESIGN_TYPE == Themetype.whatsapp
                            ? chatDeepGreen.withOpacity(0.3)
                            : chatBlack.withOpacity(0.1),
                        spreadRadius: 1.0,
                      ),
                    ],
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                            ...
                            style: TextStyle(
                                ...
                                fontFamily: FONTFAMILY_NAME,
                                color: DESIGN_TYPE == Themetype.whatsapp
                                    ? chatWhite.withOpacity(0.79)
                                    : chatBlack.withOpacity(0.79),
        ...
        children: <Widget>[
          ...
          Center(
            child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(chatLightGreen)),
          ),
          SizedBox(
            height: 48,
          ),
            ...
            child: Padding(
              ...
              child: PinFieldAutoFill(
                ...
                decoration: UnderlineDecoration(
                  bgColorBuilder:
                      FixedColorBuilder(chatGrey.withOpacity(0.1)),
                  textStyle: TextStyle(
                      fontSize: 22,
                      color: chatBlack,
                ...
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    chat.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6) {
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.buttoncolor ?? chatgreen,
              ),
              borderRadius:
  ...
  BoxDecoration boxDecoration(
    ...
    return BoxDecoration(
        ...
        boxShadow: showShadow
            ? [
                BoxShadow(
                    color: chatgreen, blurRadius: 10, spreadRadius: 2)
              ]
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: widget.hintStyle ??
                      TextStyle(
                          ...
                          fontSize: 15.5,
                          fontWeight: FontWeight.w400,
                          color: widget.buttonhintTextColor ?? chatGrey),
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 1),
                      borderSide: BorderSide(color: chatgreen, width: 1.5),
                    ),
