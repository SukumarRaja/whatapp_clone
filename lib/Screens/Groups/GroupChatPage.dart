...
import 'package:chat/Screens/Groups/GroupDetails.dart';
import 'package:chat/Screens/Groups/widget/groupChatBubble.dart';
...
//       //----sharing intent action:
  ...
  //                       focusNode: keyboardFocusNode,
  //                       maxLines: null,
  //                       style: TextStyle(fontSize: 16.0, color: chatBlack),
  //                       controller: textEditingController,
  //                       decoration: InputDecoration(
  //                         enabledBorder: OutlineInputBorder(
  //                           // width: 0.0 produces a thin "hairline" border
              ...
              child: GroupChatBubble(
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ? Text(
                        ...
                        style: TextStyle(
                            color: chatBlack.withOpacity(0.6),
                            fontSize: 15,
    ...
    return Positioned(
      child: isgeneratingSomethingLoader
          ? Container(
              ...
              color: DESIGN_TYPE == Themetype.whatsapp
                  ? chatBlack.withOpacity(0.2)
                  : chatWhite.withOpacity(0.2),
            )
          : Container(),
    );
  }
