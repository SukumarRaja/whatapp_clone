...
import 'package:chat/Screens/Broadcast/BroadcastDetails.dart';
...
import 'package:chat/widgets/DocumentPicker/documentPicker.dart';
...
class _BroadcastChatPageState extends State<BroadcastChatPage>
      ...
      tiles.add(ListTile(
          ...
          onTap: () async {
            ...
            await FirebaseFirestore.instance
                ...
                .delete();
            chat.toast(getTranslated(this.context, 'deleted'));
          }));
    }
  ...
  Future<Position> _determinePosition() async {
    ...
    if (permission == LocationPermission.always ||
      ...
      chat.toast(getTranslated(this.context, 'detectingloc'));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chat.getNTPWrappedWidget(Consumer<List<BroadcastModel>>(
