...
import 'package:chat/Screens/Broadcast/AddContactsToBroadcast.dart';
import 'package:chat/Screens/Groups/AddContactsToGroup.dart';
import 'package:chat/Screens/SettingsOption/settingsOption.dart';
import 'package:chat/Screens/homepage/Setupdata.dart';
import 'package:chat/Screens/notifications/AllNotifications.dart';
import 'package:chat/Screens/recent_chats/RecentChatsWithoutLastMessage.dart';
import 'package:chat/Screens/sharing_intent/SelectContactToShare.dart';
...
import 'package:chat/Services/localization/language.dart';
import 'package:chat/Utils/custom_url_launcher.dart';
import 'package:chat/Utils/error_codes.dart';
import 'package:chat/Utils/phonenumberVariantsGenerator.dart';
...
import 'package:chat/Screens/profile_settings/profileSettings.dart';
import 'package:chat/main.dart';
import 'package:chat/Screens/recent_chats/RecentsChats.dart';
...
class HomepageState extends State<Homepage>
  ...
  //       chatWrapper.setLocale(context, _locale);
  //       setState(() {});
  //     }
  //   }).catchError((onError) {
  //     chat.toast(
  ...
  triggerSharing() {
    ...
    if (_sharedText != null) {
      ...
      if (_sharedFiles!.length > observer.maxNoOfFilesInMultiSharing) {
        chat.toast(getTranslated(context, 'maxnooffiles') +
            ' ' +
  ...
  logout(BuildContext context) async {
    ...
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (BuildContext context) => chatWrapper(),
      ),
      (Route route) => false,
    );
  }
  ...
  void listenToNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if (message.data['title'] != 'Call Ended' &&
        ...
        chat.toast(getTranslated(this.context, 'newnotifications'));
      } else {
  ...
  getSignedInUserOrRedirect() async {
              ...
              builder: (BuildContext context) {
                ...
                return new WillPopScope(
                    ...
                    child: AlertDialog(
                      title: Text(
                        title,
                        style: TextStyle(color: chatDeepGreen),
                      ),
                      ...
                      actions: <Widget>[
                        TextButton(
                            child: Text(
                              btnLabel,
                              style: TextStyle(color: chatLightGreen),
                            ),
    ...
    //       });
    //       chat.toast(getTranslated(this.context, 'erroroccured'));
    //     } else {
    //       setState(() {
  ...
  Future<bool> onWillPop() {
    ...
    if (now.difference(currentBackPressTime!) > Duration(seconds: 3)) {
      ...
      chat.toast('Double Tap To Go Back');
                                                                  ...
                                                                  Navigator.push(
                                                                      ...
                                                                      new MaterialPageRoute(
                                                                          builder: (context) => ProfileSetting(
                                                                                ...
                                                                                type: chat.getAuthenticationType(biometricEnabled, _cachedModel),
                                                                              )));
                                                                },
                                                                currentUserNo:
                                                                    widget
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 17,
                  color: chatWhite.withOpacity(0.7),
