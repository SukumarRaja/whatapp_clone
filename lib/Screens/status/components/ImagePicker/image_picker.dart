                    ...
                    child: Row(children: [
                      Flexible(
                        child: TextField(
                          ...
                          style:
                              TextStyle(fontSize: 18.0, color: chatWhite),
                ...
                ? Container(
                    child: Center(
                      child: CircularProgressIndicator(
                          valueColor:
                              AlwaysStoppedAnimation<Color>(chatBlue)),
                    ),
                    color: DESIGN_TYPE == Themetype.whatsapp
        ...
        child: new Row(
            ...
            children: <Widget>[
              _buildActionButton(new Key('retake'), Icons.photo_library, () {
                chat.checkAndRequestPermission(Permission.photos)
                    .then((res) {
                  if (res) {
                    captureImage(ImageSource.gallery);
                  } else {
                    chat.showRationale(getTranslated(context, 'pgi'));
              ...
              _buildActionButton(new Key('upload'), Icons.photo_camera, () {
                chat.checkAndRequestPermission(Permission.camera)
                    .then((res) {
                  if (res) {
  ...
  Widget _buildActionButton(Key key, IconData icon, Function onPressed) {
    return new Expanded(
      ...
      child:  MaterialButton(
          ...
          color:
              DESIGN_TYPE == Themetype.whatsapp ? Colors.black : chatgreen,
          textColor: chatWhite,
